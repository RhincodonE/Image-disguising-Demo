...
class ImageDisguisingApp(QMainWindow):
    ...
    def setup_canvas_one(self):
        ...
        # At the end of this method, you might want to set the layout to the canvas_one widget
    ...
    def on_show_image_clicked(self):
        ...
        pixmap = QPixmap("./results/r1.png")  # Replace with your image path
        label.setPixmap(pixmap)

        # You can adjust the dialog size to fit your image or make other adjustments
    ...
    def on_show_image_clicked_neura(self):
        ...
        # Create a label and set the pixmap with the image you want to show
        label = QLabel(image_dialog)
        pixmap = QPixmap("./results/r2.png")  # Replace with your image path
        label.setPixmap(pixmap)
